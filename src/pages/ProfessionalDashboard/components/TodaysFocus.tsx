...
export default function TodaysFocus() {
  const actions = [
    {
      id: 1,
      title: "Update project status for 'Modern Kitchen Renovation'",
      impact: "Client is waiting for an update",
      time: "5 min",
      icon: Zap,
    ...
    {
      id: 2,
      title: "Follow up with 2 new client inquiries",
      impact: "High chance of securing new projects",
      time: "10 min",
      icon: Hand,
    ...
    {
      id: 3,
      title: "Review and approve 'Bathroom Remodel' proposal",
      impact: "Project is pending approval to start",
      time: "15 min",
      icon: RefreshCw,
      color: "text-blue-500",
      bg: "bg-blue-500/10",
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <span className="text-sm text-muted-foreground">
          You have 3 actions that could advance your projects today.
        </span>
      </div>
