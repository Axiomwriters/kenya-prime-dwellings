...
export function ProjectMediaForm({ images, previews, onImagesChange, onRemoveImage, projectType }: MediaProps) {
    const minPhotos = 5;
            ...
            <div className="bg-primary/5 border border-primary/20 rounded-lg p-4 flex items-start gap-3">
                ...
                <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                        High-quality projects require at least 5 photos. Include before and after shots for renovations.
                    </p>
                </div>
            </div>
            ...
            <div className="pt-4 border-t">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <Button variant="outline" className="justify-start text-muted-foreground">
                        <Upload className="w-4 h-4 mr-2" /> Upload Video Walkthrough
                    </Button>
                    <Button variant="outline" className="justify-start text-muted-foreground">
                        <Upload className="w-4 h-4 mr-2" /> Upload Blueprints
                    </Button>
                </div>
            </div>
        </div>
