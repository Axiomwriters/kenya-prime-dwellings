...
export function EmptyProjectState({ onAddProject }: EmptyStateProps) {
    return (
        <div className="relative overflow-hidden rounded-2xl border border-dashed border-primary/30 bg-primary/5 p-12 text-center">
            ...
            <div className="relative z-10 max-w-lg mx-auto space-y-8">
                <div className="space-y-2">
                    <h3 className="text-2xl font-bold">Ready to Showcase Your Work? 🚀</h3>
                    <p className="text-muted-foreground">
                        Professionals with a portfolio of 5+ projects win <strong>3x more clients</strong>. Let's get your first project live and seen by thousands.
                    </p>
                </div>
                ...
                <div className="bg-card/80 backdrop-blur-sm rounded-xl p-6 border border-border/50 text-left space-y-4 shadow-sm">
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center gap-3 opacity-50">
                            ...
                            <span className="text-sm line-through">Create Professional Profile</span>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-sm font-medium">Add First Project</span>
                            <Button size="sm" variant="secondary" className="h-6 ml-auto text-xs" onClick={onAddProject}>Start Now</Button>
                        </div>
                        ...
                        <div className="flex items-center gap-3 text-muted-foreground">
                            ...
                            <span className="text-sm">Enable Client Inquiries</span>
                        </div>
                    </div>
                </div>

                <Button size="lg" onClick={onAddProject} className="w-full sm:w-auto shadow-xl shadow-primary/20">
