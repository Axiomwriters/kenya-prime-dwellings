...
export function AgentSidebar({ onNavigate, isMobileOpen = false, onMobileToggle }: AgentSidebarProps) {
  return (
    <>
      ...
      <div 
        className={cn(
          "fixed left-0 top-0 z-50 h-full w-64 bg-background border-r border-border/50 shadow-xl transform transition-transform duration-300 ease-in-out md:hidden flex flex-col",
      ...
      >
        ...
        <div className="shrink-0 p-4 border-t border-border/50 bg-background/95">
